        ...
        <script type="text/javascript">
        	function getSelectedCourse()
        	{
        		...
        		if(selectedCourse !== "")
        		{
        			...
        			xhr.open("GET","/getCoursePrice?selectedCourse=" + encodeURIComponent(selectedCourse), true);
                ...
                <div class="row">
                    ...
                    <div class="col-6 d-flex justify-content-center">
                        <div class="addEmp_div_design bg-light">
                            <h3>Sale Course</h3><br/>
                            <form:form action="salesCourseForm" method="post" modelAttribute="modelSaleCourseAttr">
                           	<div class="mb-3">
