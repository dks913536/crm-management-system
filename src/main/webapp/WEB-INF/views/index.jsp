        ...
        <div class="container-fluid">
            <div class="row main_page_banner">
                <div class="col-8" style="padding: 50px">
                    <span class="main_page_title">CRM Application helps 250,000+ businesses run their day-to-day operations better. Close more deals, build lasting customer relationships and grow your business effortlessly.</span>
                </div> 
                ...
                <div class="row" style="padding-top: 50px">
                    ...
                    <div class="col-6" style="float: left">
                        ...
                        <ul>
                            ...
                            <li>Sales force customers report 37% more sales revenue, 45% higher customer satisfaction, 43% better marketing ROI *.</li>
                        </ul>
                    </div>                  
                </div>
            </div>
