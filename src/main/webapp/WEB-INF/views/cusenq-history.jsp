...
<html>
    <head>
        <meta charset="UTF-8">
        <title>customerEnquiry-history</title>
                ...
                <div class="row">
                    <div class="col-6 d-flex justify-content-center">
                        <div class="addEmp_div_design bg-light">
                            ...
                            <p><strong>Below is the history of customer : <span class="text-primary"> ${model_custenq.get(0).getName()} (${model_custenq.get(0).getPhoneno()})</span></strong></p> 
                            <br/>         
                            ...
                            <form:form action="custEnquiryForm" method="post" modelAttribute="modelCustEnquiryAttr">
	                            ...
	                            <div class="mb-3">
	                                ...
	                                <form:select path="custEnquiry.enquirytype" id="enquirytypeInput" cssClass="form-select"> 
	                                	<form:option value="">Selected Enquiry Type</form:option>
